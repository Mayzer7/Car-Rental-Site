...
SECRET_KEY = 'django-insecure-$0lyuec1!jh!n_t5#-l)%*@^9@cuyee%dsu!1swyun*$l7s_l+'
...
LOGIN_URL = '/user/login/'  # URL страницы логина
...
CACHES = {
    'default': {
        ...
        'TIMEOUT': 60 * 5,  # Кэширование на 5 минут (в секундах)
    }
}
